 ...
 * - Default logo: public/assets/logo/default-logo.png
 * - Recommended size: 200x80px (max width: 200px, height: auto)
 */
...
export function renderInvoiceHTML(invoice, storeSettings = null) {
  ...
  const logoPath = storeSettings?.logoPath || "/assets/logo/default-logo.png";
